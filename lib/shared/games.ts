...
export const GAMES: Record<GameId, GameMeta> = {
  ...
  tag: {
    ...
    icon: "❄️",
    rules: "🔵 BLUE are the freezers (they glow) — chase the 🩷 PINK runners and just bumping into one freezes it solid (no button, contact does it). PINK: free a frozen teammate the same way, by running into them. At the buzzer, any PINK still frozen is eliminated — and any BLUE freezer who caught NOBODY goes down too.",
    controls: ["move", "team"],
    controlText: "Move with WASD / Arrows or drag — there's no action button, you tag just by bumping. BLUE: run into pink runners to FREEZE them (catch at least one!). PINK: flee the glow, and run into a frozen teammate to THAW them.",
    lengthHint: "~35s",
    requiresEven: true,
    minPlayers: 4,
    arena: "field",
