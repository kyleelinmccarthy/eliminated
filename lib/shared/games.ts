...
export const GAMES: Record<GameId, GameMeta> = {
  ...
  koth: {
    id: "koth",
    name: "King of Lava Island",
    tagline: "The floor is lava. The island is shrinking. The crown is petty.",
    icon: "🌋",
    rules: "THE FINALE. The floor turns to lava and the safe island shrinks. Step in lava and you burn out. Shove rivals off, grab powerups, and rule the island. The last blob standing is CHAMPION.",
    controls: ["move"],
    controlText: "Move with WASD / Arrows or drag. Stay on the shrinking island — and bump rivals into the lava!",
    minPlayers: 3,
    arena: "field",
    cull: "high",
    finale: true,
    flavors: [
      "All thrones are temporary. This one is also on fire.",
      "The floor is lava. Management insists this is a feature.",
      "One island. One crown. One survivor. Several puddles.",
    ],
  },
};
